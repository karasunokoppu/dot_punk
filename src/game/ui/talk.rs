...
use crate::{core::systems::despawn_screen, game::ui::talk::text_window_system::{flip_choice_color, read_talk_text, TalkTextBoxMarker}, GameState};
...
pub fn talk_ui_plugin(app: &mut App) {
    ...
    .add_systems(Update, flip_choice_color.run_if(not(in_state(TalkTextBoxType::Disabled).and(in_state(TalkTextBoxType::Text)))));
}